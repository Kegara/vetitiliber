...
class ListadoleiPage extends StatefulWidget {
  ListadoleiPage({Key key, this.title}) : super(key: key);
  final String title;
  static String id = 'ListadoleiPage';
  @override
  _ListadoleiPage createState() => _ListadoleiPage();
}
...
class _ListadoleiPage extends State<ListadoleiPage> {
  //listado de libros
